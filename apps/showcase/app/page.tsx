                ...
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <Link href="/portfolio" className="card card-body">
                        <div className="flex gap-4 items-center mb-4">
                            ...
                            <h3 className="text-xl font-bold dark:text-white">Portfolio</h3>
                        </div>
                    ...
                    <Link href="/resume" className="card card-body">
                        <div className="flex gap-4 items-center mb-4">
                            ...
                            <h3 className="text-xl font-bold dark:text-white">Resume</h3>
                        </div>
                    ...
                    <div className="card card-body">
                        <div className="flex gap-4 items-center mb-4">
                            ...
                            <h3 className="text-xl font-bold dark:text-white">Enterprise Design</h3>
                        </div>
                        <p className="text-gray-500 dark:text-gray-400">
                    ...
                    <div className="card card-body">
                        <div className="flex gap-4 items-center mb-4">
                            ...
                            <h3 className="text-xl font-bold dark:text-white">Operations</h3>
                        </div>
                        <p className="text-gray-500 dark:text-gray-400">
