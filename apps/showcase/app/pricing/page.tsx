            ...
            <main id="content">
                        ...
                        <nav className="mx-auto w-full max-w-[85rem] px-4 md:px-6 lg:px-8">
                            <div className="relative md:flex md:items-center md:justify-between">
                                <div className="flex items-center justify-between">
                                    <Link
                                        className="focus:outline-hidden flex flex-none gap-2 focus:opacity-80"
                                        href="/">
                                        <ApplicationLogo />
                ...
                <div className="relative">
                    <div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 md:py-14 lg:px-8 lg:py-20">
                        ...
                        {/* <!-- Header --> */}
                        <div className="sticky start-0 top-0 hidden bg-white/60 py-2 backdrop-blur-md lg:block dark:bg-neutral-900/60">
                            {/* <!-- Grid --> */}
                        ...
                        <div className="space-y-4 lg:space-y-0">
                            <ul className="grid lg:grid-cols-6 lg:gap-6">
                                ...
                                <li className="hidden px-4 py-1.5 lg:col-span-1 lg:block lg:px-0 lg:py-3 lg:text-center"></li>
                            ...
                            <ul className="grid lg:grid-cols-6 lg:gap-6">
                                <li className="pb-1.5 lg:col-span-2 lg:py-3">
                                    <span className="text-sm font-semibold text-gray-800 lg:font-normal dark:text-neutral-200">
                                        Number of seats
                                    </span>
                                </li>

                                <li className="col-span-1 border-b border-gray-200 py-1.5 lg:py-3 dark:border-neutral-800">
                                    <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                                        <span className="text-sm text-gray-800 md:col-span-2 lg:hidden dark:text-neutral-200">
                                            Free
                                        </span>
                        ...
                        <div className="mt-6 hidden lg:block">
                            ...
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-1">
                                    <a
                                        className="shadow-2xs focus:outline-hidden inline-flex w-full items-center justify-center gap-x-2 rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-800 hover:bg-gray-50 focus:bg-gray-50 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-transparent dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                        href="#">
                                        Get started
                                    </a>
                                </div>
                        ...
                        <div className="mt-8 flex items-center justify-center gap-x-3 md:mt-12">
                            ...
                            <button
                                type="button"
                                className="shadow-2xs focus:outline-hidden inline-flex items-center gap-x-2 rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-800 hover:bg-gray-50 focus:bg-gray-50 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-transparent dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800">
                                Contact us
                            </button>
                        </div>
                        {/* <!-- End Button Group --> */}
