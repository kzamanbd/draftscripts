                        ...
                        <div className="flex items-center space-x-8">
                            ...
                            <nav className="flex items-center space-x-4">
                                ...
                                <button
                                    ...
                                    Search
                                    <span className="bg-primary-100 text-primary-800 ml-2 rounded px-2 py-0.5 text-xs font-medium">
                                        New
                                    </span>
                                </button>
                            </nav>
                                    ...
                                    <ul className="hs-dropdown-menu dropdown-menu user-profile-dropdown">
                                        ...
                                        <li className="user-menu-item">
                                            <a href="#" className="user-menu-link">
                                                <span className="icon-[mdi--wallet]"></span>
                                                <span>Billing</span>
                                            </a>
                                        </li>
                                        <li className="user-menu-item">
                                            <a href="#" className="user-menu-link">
                                                <span className="icon-[mdi--cog]"></span>
                                                <span>Settings</span>
                                            </a>
                                        </li>
                                        <li className="user-menu-item">
                                        ...
                                        <li className="user-menu-item">
                                            <LogoutButton className="user-menu-link">
                                                Sign out
                                            </LogoutButton>
                                        </li>
                                    </ul>
